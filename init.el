...
(require 'flymake)
(setq flymake-allowed-file-name-masks '("\\.c\\'" "\\.h\\'" "\\.cpp\\'"))
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("6bdc4e5f585bb4a500ea38f563ecf126570b9ab3be0598bdf607034bb07a8875"
     ...
     "81b6536ffa1466fa00f9b8dcd14c0995ef15d595ab903572bba484b6be3eacaa"
 ...
 '(term-bind-key-alist
   '(("C-c C-c" . term-interrupt-subjob) ("C-p" . previous-line)
     ...
     ("C-m" . term-send-raw) ("M-f" . term-send-forward-word)
     ("M-b" . term-send-backward-word) ("M-o" . term-send-backspace)
     ("M-p" . term-send-up) ("M-n" . term-send-down)
     ("M-M" . term-send-forward-kill-word)
     ("M-N" . term-send-backward-kill-word)
     ("M-r" . term-send-reverse-search-history) ("M-," . term-send-input)
     ("M-." . comint-dynamic-complete) ("C-c C-j" . term-line-mode)
     ("C-c C-k" . term-char-mode) ("C-c C-e" . term-send-escape)))
